...
import regmeet from "../../images/regmeet.png";
import friendBook from "../../images/friendbook.jpg";
...
const Projects = () => {
  ...
  const androidApps = [
    {
      title: "FriendBook",
      des: "A tinder application. Choose your dating partner or swipe",
      img: friendBook,
      liveLink: "https://github.com/YeasinHowladerEmon/Friendbook",
    },
  ];
  ...
  const webApps = [
    {
      title: "RegMeet",
      des: "This is a social media web app.",
      img: regmeet,
      liveLink: "https://regmeet.netlify.app/",
    },
    {
      title: "Code Punk",
  ...
  return (
    <section className="projectsSection">
      <div className="projectsHeader d-flex justify-content-space align-center">
        ...
        <a
          className="text-white f-30 hoverIcon transition"
      ...
      <div>
        <h1 className="text-white montserrat">Android Application</h1>
        <div className="projectsContainer">
